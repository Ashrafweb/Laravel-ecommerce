          ...
          <div class="aa-product-catg-content">
            ...
            <div class="aa-product-catg-body">
              ...
              @foreach($products as $prod)
                    <li>
                      <figure>
                        <a class="aa-product-img" href="{{url('/product_detail/'.$prod->id)}}"><img src="{{asset('storage/media/'.$prod->image)}}" width="250px" height="300px" alt="polo shirt img"></a>
                        <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                         <figcaption>
                          <h4 class="aa-product-title"><a href="#">{{$prod->product_name}}</a></h4>
                          <span class="aa-product-price">${{$product_details[$prod->id][0]->price}}</span><span class="aa-product-price"><del>${{$product_details[$prod->id][0]->mrp}}</del></span>
                        </figcaption>
                      </figure>                     
                            ...
                            <div class="simpleLens-gallery-container" id="demo-1">
                              ...
                              <div class="simpleLens-thumbnails-container">
                                  <a href="#" class="simpleLens-thumbnail-wrapper"
                                     ...
                                     data-big-image="{{asset('img/view-slider/medium/polo-shirt-1.png')}}">
        ...
        <div class="col-lg-3 col-md-3 col-sm-4 col-md-pull-9">
          <aside class="aa-sidebar">
            ...
            <div class="aa-sidebar-widget">
              ...
              <li class="active"><a href="{{url('/category/'.$list->category_slug)}}">{{$list->category_name}}</a></li>
