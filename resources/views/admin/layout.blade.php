                   ...
                   <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{url('admin/products')}}">
                                <i class="fa fa-product-hunt"><b style="font-family:Courier New;font-style: normal;font-size: 30px;
                                font-weight: 900;">P</b></i>Products</a>
                        </li>

                        <li>
                            <a href="{{url('admin/order')}}">
                                <i class="fa fa-product-hunt"><b style="font-family:Courier New;font-style: normal;font-size: 30px;
                                font-weight: 900;">O</b></i>Order</a>
                        </li>
                        ...
                        <li>
                            <a href="{{url('admin/brand')}}">
                                <i class=""><b style="font-family:Courier New;font-style: normal;font-size: 30px;
                                font-weight: 900;">B</b></i>Brand</a>
                        </li>

                        <li>
                            <a href="{{url('admin/banner')}}">
                                <i class="fa fa-banner"><b style="font-family:Courier New;font-style: normal;font-size: 30px;
                                font-weight: 900;">Ba</b>nner</i></a>
                        </li>
